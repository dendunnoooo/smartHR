        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <x-form.input-block>
                    ...
                    <x-form.input type="email" name="email" value="{{ $employee->email }}" placeholder="employee@smarthr.com" />
                </x-form.input-block>
            </div>
            <div class="col-md-6">
                <x-form.input-block>
                ...
                <x-form.input-block>
                    ...
                    <select name="schedule_id" id="schedule_id" class="select">
                        ...
                        @foreach (\App\Models\Schedule::where('is_active', true)->get() as $schedule)
                            <option value="{{ $schedule->id }}" {{ $employee->schedule_id == $schedule->id ? 'selected' : '' }}>
                                {{ $schedule->name }} ({{ $schedule->time_range }})
                            </option>
                        @endforeach
                    </select>
                </x-form.input-block>
